...
public class UserDAO extends DBContext {
    ...
    public Vector<User> getAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                User u = new User(id, username, password, fullname, email, phone, address, role_id, id);
                users.add(u);
            }
            return users;
    ...
    //changeInfo trong cart
    public void ChangeInfoInCart(String fullname, String phone, String address, String username) {
