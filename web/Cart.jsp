                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${sessionScope.user != null}" >
                                            <form action="changeinfo" method="post">
                                                <input type="hidden" name="accId" value="${sessionScope.user.username}"/>
                                                <input type="hidden" name="accPass" value="${sessionScope.user.password}"/>

                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Name</span>
                                                    </div>
                                                    <input type="text" class="form-control" name="userName" value="${sessionScope.user.fullname}" required/>
                                                    <a class="change input-group-text" style="display: ${block}">${newname}</a>
                                                </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="userPhone" value="${sessionScope.user.phone}" required/>
                                                    <a class="change input-group-text" style="display: ${block}">${newPhone}</a>
                                                </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="userAddress" value="${sessionScope.user.address}" required/>
                                                    <a class="change input-group-text" style="display: ${block}">${newAddress}</a>
                                                </div>

                                                <input type="submit" class="btn btn-primary" value="Change info"/>
                                                <h6 style="margin-top: 10px; align-content: center; color: red;">${mess}</h6><br>
                                                <hr>
                                            </form>
                                        </c:if>
